...
function eventHandlerClass(id) {
    switch (id) {
        case 1:
            getTag('classname').innerHTML = "Nome: Bárbaro"
        ...
        case 2:
            getTag('classname').innerHTML = "Nome: Bardo"
        ...
        case 3:
            getTag('classname').innerHTML = "Nome: Bruxo"
            getTag('lifedice').innerHTML = "Dados de vida: 1d8 por nível de bardo"
        ...
        case 4:
            getTag('classname').innerHTML = "Nome: Clérigo"
            getTag('lifedice').innerHTML = "Dados de vida: 1d8 por nível de bardo"
        ...
        case 5:
            getTag('classname').innerHTML = "Nome: Druida"
            getTag('lifedice').innerHTML = "Dados de vida: 1d8 por nível de bardo"
        ...
        case 6:
            getTag('classname').innerHTML = "Nome: Feiticeiro"
        ...
        case 7:
            getTag('classname').innerHTML = "Nome: Guerreiro"
        ...
        case 8:
            getTag('classname').innerHTML = "Nome: Ladino"
            getTag('lifedice').innerHTML = "Dados de vida: 1d8 por nível de bardo"
        ...
        case 9:
            getTag('classname').innerHTML = "Nome: Mago"
            getTag('lifedice').innerHTML = "Dados de vida: 1d6 por nível de bardo"
        ...
        case 10:
            getTag('classname').innerHTML = "Nome: Monge"
            getTag('lifedice').innerHTML = "Dados de vida: 1d8 por nível de bardo"
        ...
        case 11:
            getTag('classname').innerHTML = "Nome: Paladino"
            ...
            break;
        case 12:
            getTag('classname').innerHTML = "Nome: Patrulheiro"
            getTag('lifedice').innerHTML = "Dados de vida: 1d10 por nível de paladino"
...
function eventHandlerRace(id) {
    switch (id) {
        case 1:
            getTag('racename').innerHTML = "Nome: Anão"
        ...
        case 2:
            getTag('racename').innerHTML = "Nome: Elfo"
        ...
        case 3:
            getTag('racename').innerHTML = "Nome: Halfling"
            getTag('attributes').innerHTML = "Atributos: Destreza +2"
        ...
        case 4:
            getTag('racename').innerHTML = "Nome: Humano"
        ...
        case 5:
            getTag('racename').innerHTML = "Nome: Draconato"
        ...
        case 6:
            getTag('racename').innerHTML = "Nome: Gnomo"
        ...
        case 7:
            getTag('racename').innerHTML = "Nome: Meio-Elfo"
            getTag('attributes').innerHTML = "Atributos: Carisma +2, 2 atributos +1"
        ...
        case 8:
            getTag('racename').innerHTML = "Nome: Meio-Orc"
            ...
            break;
        case 9:
            getTag('racename').innerHTML = "Nome: Tiefling"
